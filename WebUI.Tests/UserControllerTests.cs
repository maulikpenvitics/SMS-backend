    ...
    public class UserControllerTests
    {
       ...
       public void TestUserModule()
       {
            ...
            try
            {
                ...
                using (StreamReader r = new StreamReader(RootPath+ "Request/User/Request.json"))
                {
                    string json = r.ReadToEnd();
                    UserObj = JsonConvert.DeserializeObject<List<User>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var UserItem in UserObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(UserItem) as ViewResult;
                    Assert.IsTrue(UserItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(UserItem.Id) as ViewResult;
                    Assert.IsTrue(UserItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(UserItem) as ViewResult;
                    Assert.IsTrue(UserItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(UserItem.Id) as ViewResult;
                    Assert.IsTrue(UserItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ UserItem.Id+"\n";
                }
