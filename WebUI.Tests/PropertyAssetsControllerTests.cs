...
{
    [TestClass]
    public class PropertyAssetsControllerTests
    {
       [TestMethod]
       public void TestPropertyAssetsModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "PropertyAssets";
            ...
            try
            {
                ...
                PropertyAssetsController controller = new PropertyAssetsController();
                ...
                PropertyAssetsFilter Filter = new PropertyAssetsFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<PropertyAssets> PropertyAssetsObj = new List<PropertyAssets>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/PropertyAssets/Request.json"))
                {
                    string json = r.ReadToEnd();
                    PropertyAssetsObj = JsonConvert.DeserializeObject<List<PropertyAssets>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var PropertyAssetsItem in PropertyAssetsObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(PropertyAssetsItem) as ViewResult;
                    Assert.IsTrue(PropertyAssetsItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(PropertyAssetsItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyAssetsItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(PropertyAssetsItem) as ViewResult;
                    Assert.IsTrue(PropertyAssetsItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(PropertyAssetsItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyAssetsItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ PropertyAssetsItem.Id+"\n";
                }
