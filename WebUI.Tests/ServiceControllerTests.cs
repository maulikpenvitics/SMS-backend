       ...
       public void TestServiceModule()
       {
            ...
            try
            {
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<Service> ServiceObj = new List<Service>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/Service/Request.json"))
                {
                    string json = r.ReadToEnd();
                    ServiceObj = JsonConvert.DeserializeObject<List<Service>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var ServiceItem in ServiceObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(ServiceItem) as ViewResult;
                    Assert.IsTrue(ServiceItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(ServiceItem.Id) as ViewResult;
                    Assert.IsTrue(ServiceItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(ServiceItem) as ViewResult;
                    Assert.IsTrue(ServiceItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(ServiceItem.Id) as ViewResult;
                    Assert.IsTrue(ServiceItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ ServiceItem.Id+"\n";
                }
