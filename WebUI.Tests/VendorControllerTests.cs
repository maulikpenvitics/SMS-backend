    ...
    public class VendorControllerTests
    {
       ...
       public void TestVendorModule()
       {
            ...
            try
            {
                ...
                using (StreamReader r = new StreamReader(RootPath+ "Request/Vendor/Request.json"))
                {
                    string json = r.ReadToEnd();
                    VendorObj = JsonConvert.DeserializeObject<List<Vendor>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var VendorItem in VendorObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(VendorItem) as ViewResult;
                    Assert.IsTrue(VendorItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(VendorItem.Id) as ViewResult;
                    Assert.IsTrue(VendorItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(VendorItem) as ViewResult;
                    Assert.IsTrue(VendorItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(VendorItem.Id) as ViewResult;
                    Assert.IsTrue(VendorItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ VendorItem.Id+"\n";
                }
