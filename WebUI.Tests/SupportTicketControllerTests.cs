       ...
       public void TestSupportTicketModule()
       {
            ...
            try
            {
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<SupportTicket> SupportTicketObj = new List<SupportTicket>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/SupportTicket/Request.json"))
                {
                    string json = r.ReadToEnd();
                    SupportTicketObj = JsonConvert.DeserializeObject<List<SupportTicket>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var SupportTicketItem in SupportTicketObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(SupportTicketItem) as ViewResult;
                    Assert.IsTrue(SupportTicketItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(SupportTicketItem.Id) as ViewResult;
                    Assert.IsTrue(SupportTicketItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(SupportTicketItem) as ViewResult;
                    Assert.IsTrue(SupportTicketItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(SupportTicketItem.Id) as ViewResult;
                    Assert.IsTrue(SupportTicketItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ SupportTicketItem.Id+"\n";
                }
