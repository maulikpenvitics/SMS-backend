...
{
    [TestClass]
    public class AmenitiesBookingControllerTests
    {
       [TestMethod]
       public void TestAmenitiesBookingModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "AmenitiesBooking";
            ...
            try
            {
                ...
                AmenitiesBookingController controller = new AmenitiesBookingController();
                ...
                AmenitiesBookingFilter Filter = new AmenitiesBookingFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<AmenitiesBooking> AmenitiesBookingObj = new List<AmenitiesBooking>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/AmenitiesBooking/Request.json"))
                {
                    string json = r.ReadToEnd();
                    AmenitiesBookingObj = JsonConvert.DeserializeObject<List<AmenitiesBooking>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var AmenitiesBookingItem in AmenitiesBookingObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(AmenitiesBookingItem) as ViewResult;
                    Assert.IsTrue(AmenitiesBookingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(AmenitiesBookingItem.Id) as ViewResult;
                    Assert.IsTrue(AmenitiesBookingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(AmenitiesBookingItem) as ViewResult;
                    Assert.IsTrue(AmenitiesBookingItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(AmenitiesBookingItem.Id) as ViewResult;
                    Assert.IsTrue(AmenitiesBookingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ AmenitiesBookingItem.Id+"\n";
                }
