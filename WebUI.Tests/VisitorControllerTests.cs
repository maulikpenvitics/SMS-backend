       ...
       public void TestVisitorModule()
       {
            ...
            try
            {
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<Visitor> VisitorObj = new List<Visitor>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/Visitor/Request.json"))
                {
                    string json = r.ReadToEnd();
                    VisitorObj = JsonConvert.DeserializeObject<List<Visitor>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var VisitorItem in VisitorObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(VisitorItem) as ViewResult;
                    Assert.IsTrue(VisitorItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(VisitorItem.Id) as ViewResult;
                    Assert.IsTrue(VisitorItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(VisitorItem) as ViewResult;
                    Assert.IsTrue(VisitorItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(VisitorItem.Id) as ViewResult;
                    Assert.IsTrue(VisitorItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ VisitorItem.Id+"\n";
                }
