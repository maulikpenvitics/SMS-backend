...
{
    [TestClass]
    public class PropertyAmenitiesControllerTests
    {
       [TestMethod]
       public void TestPropertyAmenitiesModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "PropertyAmenities";
            ...
            try
            {
                ...
                PropertyAmenitiesController controller = new PropertyAmenitiesController();
                ...
                PropertyAmenitiesFilter Filter = new PropertyAmenitiesFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<PropertyAmenities> PropertyAmenitiesObj = new List<PropertyAmenities>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/PropertyAmenities/Request.json"))
                {
                    string json = r.ReadToEnd();
                    PropertyAmenitiesObj = JsonConvert.DeserializeObject<List<PropertyAmenities>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var PropertyAmenitiesItem in PropertyAmenitiesObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(PropertyAmenitiesItem) as ViewResult;
                    Assert.IsTrue(PropertyAmenitiesItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(PropertyAmenitiesItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyAmenitiesItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(PropertyAmenitiesItem) as ViewResult;
                    Assert.IsTrue(PropertyAmenitiesItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(PropertyAmenitiesItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyAmenitiesItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ PropertyAmenitiesItem.Id+"\n";
                }
