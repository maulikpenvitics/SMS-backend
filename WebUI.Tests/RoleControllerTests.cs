    ...
    public class RoleControllerTests
    {
       ...
       public void TestRoleModule()
       {
            ...
            try
            {
                ...
                using (StreamReader r = new StreamReader(RootPath+ "Request/Role/Request.json"))
                {
                    string json = r.ReadToEnd();
                    RoleObj = JsonConvert.DeserializeObject<List<Role>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var RoleItem in RoleObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(RoleItem) as ViewResult;
                    Assert.IsTrue(RoleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(RoleItem.Id) as ViewResult;
                    Assert.IsTrue(RoleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(RoleItem) as ViewResult;
                    Assert.IsTrue(RoleItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(RoleItem.Id) as ViewResult;
                    Assert.IsTrue(RoleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ RoleItem.Id+"\n";
                }
