...
{
    [TestClass]
    public class PropertyDocsControllerTests
    {
       [TestMethod]
       public void TestPropertyDocsModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "PropertyDocs";
            ...
            try
            {
                ...
                PropertyDocsController controller = new PropertyDocsController();
                ...
                PropertyDocsFilter Filter = new PropertyDocsFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<PropertyDocs> PropertyDocsObj = new List<PropertyDocs>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/PropertyDocs/Request.json"))
                {
                    string json = r.ReadToEnd();
                    PropertyDocsObj = JsonConvert.DeserializeObject<List<PropertyDocs>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var PropertyDocsItem in PropertyDocsObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(PropertyDocsItem) as ViewResult;
                    Assert.IsTrue(PropertyDocsItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(PropertyDocsItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyDocsItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(PropertyDocsItem) as ViewResult;
                    Assert.IsTrue(PropertyDocsItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(PropertyDocsItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyDocsItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ PropertyDocsItem.Id+"\n";
                }
