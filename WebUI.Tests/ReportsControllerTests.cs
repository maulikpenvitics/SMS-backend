    ...
    public class ReportsControllerTests
    {
       ...
       public void TestReportsModule()
       {
            ...
            try
            {
                ...
                ReportsFilter Filter = new ReportsFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<Reports> ReportsObj = new List<Reports>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/Reports/Request.json"))
                {
                    string json = r.ReadToEnd();
                    ReportsObj = JsonConvert.DeserializeObject<List<Reports>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var ReportsItem in ReportsObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(ReportsItem) as ViewResult;
                    Assert.IsTrue(ReportsItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(ReportsItem.Id) as ViewResult;
                    Assert.IsTrue(ReportsItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(ReportsItem) as ViewResult;
                    Assert.IsTrue(ReportsItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(ReportsItem.Id) as ViewResult;
                    Assert.IsTrue(ReportsItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ ReportsItem.Id+"\n";
                }
