...
namespace WebUI.Tests
{
    ...
    {
       [TestMethod]
       public void TestAccountingModule()
       {
            ...
            try
            {
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<Accounting> AccountingObj = new List<Accounting>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/Accounting/Request.json"))
                {
                    string json = r.ReadToEnd();
                    AccountingObj = JsonConvert.DeserializeObject<List<Accounting>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var AccountingItem in AccountingObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(AccountingItem) as ViewResult;
                    Assert.IsTrue(AccountingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(AccountingItem.Id) as ViewResult;
                    Assert.IsTrue(AccountingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(AccountingItem) as ViewResult;
                    Assert.IsTrue(AccountingItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(AccountingItem.Id) as ViewResult;
                    Assert.IsTrue(AccountingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ AccountingItem.Id+"\n";
                }
