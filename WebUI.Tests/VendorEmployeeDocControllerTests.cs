...
{
    [TestClass]
    public class VendorEmployeeDocControllerTests
    {
       [TestMethod]
       public void TestVendorEmployeeDocModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "VendorEmployeeDoc";
            ...
            try
            {
                ...
                VendorEmployeeDocController controller = new VendorEmployeeDocController();
                ...
                VendorEmployeeDocFilter Filter = new VendorEmployeeDocFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<VendorEmployeeDoc> VendorEmployeeDocObj = new List<VendorEmployeeDoc>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/VendorEmployeeDoc/Request.json"))
                {
                    string json = r.ReadToEnd();
                    VendorEmployeeDocObj = JsonConvert.DeserializeObject<List<VendorEmployeeDoc>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var VendorEmployeeDocItem in VendorEmployeeDocObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(VendorEmployeeDocItem) as ViewResult;
                    Assert.IsTrue(VendorEmployeeDocItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(VendorEmployeeDocItem.Id) as ViewResult;
                    Assert.IsTrue(VendorEmployeeDocItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(VendorEmployeeDocItem) as ViewResult;
                    Assert.IsTrue(VendorEmployeeDocItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(VendorEmployeeDocItem.Id) as ViewResult;
                    Assert.IsTrue(VendorEmployeeDocItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ VendorEmployeeDocItem.Id+"\n";
                }
