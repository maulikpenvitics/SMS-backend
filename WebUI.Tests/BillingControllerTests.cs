    ...
    public class BillingControllerTests
    {
       ...
       public void TestBillingModule()
       {
            ...
            try
            {
                ...
                using (StreamReader r = new StreamReader(RootPath+ "Request/Billing/Request.json"))
                {
                    string json = r.ReadToEnd();
                    BillingObj = JsonConvert.DeserializeObject<List<Billing>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var BillingItem in BillingObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(BillingItem) as ViewResult;
                    Assert.IsTrue(BillingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(BillingItem.Id) as ViewResult;
                    Assert.IsTrue(BillingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(BillingItem) as ViewResult;
                    Assert.IsTrue(BillingItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(BillingItem.Id) as ViewResult;
                    Assert.IsTrue(BillingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ BillingItem.Id+"\n";
                }
