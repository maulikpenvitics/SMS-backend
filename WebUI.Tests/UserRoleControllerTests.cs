...
namespace WebUI.Tests
{
    ...
    {
       [TestMethod]
       public void TestUserRoleModule()
       {
            ...
            try
            {
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<UserRole> UserRoleObj = new List<UserRole>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/UserRole/Request.json"))
                {
                    string json = r.ReadToEnd();
                    UserRoleObj = JsonConvert.DeserializeObject<List<UserRole>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var UserRoleItem in UserRoleObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(UserRoleItem) as ViewResult;
                    Assert.IsTrue(UserRoleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(UserRoleItem.Id) as ViewResult;
                    Assert.IsTrue(UserRoleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(UserRoleItem) as ViewResult;
                    Assert.IsTrue(UserRoleItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(UserRoleItem.Id) as ViewResult;
                    Assert.IsTrue(UserRoleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ UserRoleItem.Id+"\n";
                }
