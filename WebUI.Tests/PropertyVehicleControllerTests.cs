...
{
    [TestClass]
    public class PropertyVehicleControllerTests
    {
       [TestMethod]
       public void TestPropertyVehicleModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "PropertyVehicle";
            ...
            try
            {
                ...
                PropertyVehicleController controller = new PropertyVehicleController();
                ...
                PropertyVehicleFilter Filter = new PropertyVehicleFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<PropertyVehicle> PropertyVehicleObj = new List<PropertyVehicle>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/PropertyVehicle/Request.json"))
                {
                    string json = r.ReadToEnd();
                    PropertyVehicleObj = JsonConvert.DeserializeObject<List<PropertyVehicle>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var PropertyVehicleItem in PropertyVehicleObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(PropertyVehicleItem) as ViewResult;
                    Assert.IsTrue(PropertyVehicleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(PropertyVehicleItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyVehicleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(PropertyVehicleItem) as ViewResult;
                    Assert.IsTrue(PropertyVehicleItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(PropertyVehicleItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyVehicleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ PropertyVehicleItem.Id+"\n";
                }
