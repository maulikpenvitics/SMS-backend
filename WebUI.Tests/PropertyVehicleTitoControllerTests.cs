...
{
    [TestClass]
    public class PropertyVehicleTitoControllerTests
    {
       [TestMethod]
       public void TestPropertyVehicleTitoModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "PropertyVehicleTito";
            ...
            try
            {
                ...
                PropertyVehicleTitoController controller = new PropertyVehicleTitoController();
                ...
                PropertyVehicleTitoFilter Filter = new PropertyVehicleTitoFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<PropertyVehicleTito> PropertyVehicleTitoObj = new List<PropertyVehicleTito>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/PropertyVehicleTito/Request.json"))
                {
                    string json = r.ReadToEnd();
                    PropertyVehicleTitoObj = JsonConvert.DeserializeObject<List<PropertyVehicleTito>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var PropertyVehicleTitoItem in PropertyVehicleTitoObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(PropertyVehicleTitoItem) as ViewResult;
                    Assert.IsTrue(PropertyVehicleTitoItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(PropertyVehicleTitoItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyVehicleTitoItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(PropertyVehicleTitoItem) as ViewResult;
                    Assert.IsTrue(PropertyVehicleTitoItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(PropertyVehicleTitoItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyVehicleTitoItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ PropertyVehicleTitoItem.Id+"\n";
                }
