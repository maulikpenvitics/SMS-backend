...
{
    [TestClass]
    public class VendorEmpRatingControllerTests
    {
       [TestMethod]
       public void TestVendorEmpRatingModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "VendorEmpRating";
            ...
            try
            {
                ...
                VendorEmpRatingController controller = new VendorEmpRatingController();
                ...
                VendorEmpRatingFilter Filter = new VendorEmpRatingFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<VendorEmpRating> VendorEmpRatingObj = new List<VendorEmpRating>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/VendorEmpRating/Request.json"))
                {
                    string json = r.ReadToEnd();
                    VendorEmpRatingObj = JsonConvert.DeserializeObject<List<VendorEmpRating>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var VendorEmpRatingItem in VendorEmpRatingObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(VendorEmpRatingItem) as ViewResult;
                    Assert.IsTrue(VendorEmpRatingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(VendorEmpRatingItem.Id) as ViewResult;
                    Assert.IsTrue(VendorEmpRatingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(VendorEmpRatingItem) as ViewResult;
                    Assert.IsTrue(VendorEmpRatingItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(VendorEmpRatingItem.Id) as ViewResult;
                    Assert.IsTrue(VendorEmpRatingItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ VendorEmpRatingItem.Id+"\n";
                }
