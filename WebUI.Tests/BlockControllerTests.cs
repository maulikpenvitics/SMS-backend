       ...
       public void TestBlockModule()
       {
            ...
            try
            {
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<Block> BlockObj = new List<Block>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/Block/Request.json"))
                {
                    string json = r.ReadToEnd();
                    BlockObj = JsonConvert.DeserializeObject<List<Block>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var BlockItem in BlockObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(BlockItem) as ViewResult;
                    Assert.IsTrue(BlockItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(BlockItem.Id) as ViewResult;
                    Assert.IsTrue(BlockItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(BlockItem) as ViewResult;
                    Assert.IsTrue(BlockItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(BlockItem.Id) as ViewResult;
                    Assert.IsTrue(BlockItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ BlockItem.Id+"\n";
                }
