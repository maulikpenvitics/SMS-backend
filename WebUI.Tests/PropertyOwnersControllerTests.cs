...
{
    [TestClass]
    public class PropertyOwnersControllerTests
    {
       [TestMethod]
       public void TestPropertyOwnersModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "PropertyOwners";
            ...
            try
            {
                ...
                PropertyOwnersController controller = new PropertyOwnersController();
                ...
                PropertyOwnersFilter Filter = new PropertyOwnersFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<PropertyOwners> PropertyOwnersObj = new List<PropertyOwners>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/PropertyOwners/Request.json"))
                {
                    string json = r.ReadToEnd();
                    PropertyOwnersObj = JsonConvert.DeserializeObject<List<PropertyOwners>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var PropertyOwnersItem in PropertyOwnersObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(PropertyOwnersItem) as ViewResult;
                    Assert.IsTrue(PropertyOwnersItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(PropertyOwnersItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyOwnersItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(PropertyOwnersItem) as ViewResult;
                    Assert.IsTrue(PropertyOwnersItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(PropertyOwnersItem.Id) as ViewResult;
                    Assert.IsTrue(PropertyOwnersItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ PropertyOwnersItem.Id+"\n";
                }
