...
{
    [TestClass]
    public class VendorInvoiceDetailControllerTests
    {
       [TestMethod]
       public void TestVendorInvoiceDetailModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "VendorInvoiceDetail";
            ...
            try
            {
                ...
                VendorInvoiceDetailController controller = new VendorInvoiceDetailController();
                ...
                VendorInvoiceDetailFilter Filter = new VendorInvoiceDetailFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<VendorInvoiceDetail> VendorInvoiceDetailObj = new List<VendorInvoiceDetail>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/VendorInvoiceDetail/Request.json"))
                {
                    string json = r.ReadToEnd();
                    VendorInvoiceDetailObj = JsonConvert.DeserializeObject<List<VendorInvoiceDetail>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var VendorInvoiceDetailItem in VendorInvoiceDetailObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(VendorInvoiceDetailItem) as ViewResult;
                    Assert.IsTrue(VendorInvoiceDetailItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(VendorInvoiceDetailItem.Id) as ViewResult;
                    Assert.IsTrue(VendorInvoiceDetailItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(VendorInvoiceDetailItem) as ViewResult;
                    Assert.IsTrue(VendorInvoiceDetailItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(VendorInvoiceDetailItem.Id) as ViewResult;
                    Assert.IsTrue(VendorInvoiceDetailItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ VendorInvoiceDetailItem.Id+"\n";
                }
