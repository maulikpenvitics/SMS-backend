...
{
    [TestClass]
    public class VendorServiceControllerTests
    {
       [TestMethod]
       public void TestVendorServiceModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "VendorService";
            ...
            try
            {
                ...
                VendorServiceController controller = new VendorServiceController();
                ...
                VendorServiceFilter Filter = new VendorServiceFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<VendorService> VendorServiceObj = new List<VendorService>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/VendorService/Request.json"))
                {
                    string json = r.ReadToEnd();
                    VendorServiceObj = JsonConvert.DeserializeObject<List<VendorService>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var VendorServiceItem in VendorServiceObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(VendorServiceItem) as ViewResult;
                    Assert.IsTrue(VendorServiceItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(VendorServiceItem.Id) as ViewResult;
                    Assert.IsTrue(VendorServiceItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(VendorServiceItem) as ViewResult;
                    Assert.IsTrue(VendorServiceItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(VendorServiceItem.Id) as ViewResult;
                    Assert.IsTrue(VendorServiceItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ VendorServiceItem.Id+"\n";
                }
