       ...
       public void TestSecurityModule()
       {
            ...
            try
            {
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<Security> SecurityObj = new List<Security>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/Security/Request.json"))
                {
                    string json = r.ReadToEnd();
                    SecurityObj = JsonConvert.DeserializeObject<List<Security>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var SecurityItem in SecurityObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(SecurityItem) as ViewResult;
                    Assert.IsTrue(SecurityItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(SecurityItem.Id) as ViewResult;
                    Assert.IsTrue(SecurityItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(SecurityItem) as ViewResult;
                    Assert.IsTrue(SecurityItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(SecurityItem.Id) as ViewResult;
                    Assert.IsTrue(SecurityItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ SecurityItem.Id+"\n";
                }
