...
{
    [TestClass]
    public class VendorEmployeeRoleControllerTests
    {
       [TestMethod]
       public void TestVendorEmployeeRoleModule()
       {
            string RootPath = ConfigurationManager.AppSettings["Root"];
            string ResultTest = string.Empty;
            string StrDate = DateTime.Now.ToShortDateString();
            string ModuleName = "VendorEmployeeRole";
            ...
            try
            {
                ...
                VendorEmployeeRoleController controller = new VendorEmployeeRoleController();
                ...
                VendorEmployeeRoleFilter Filter = new VendorEmployeeRoleFilter();
                /////////////////Start List Testcase/////////////////
                ...
                /////////////////End Create Action Testcase/////////////////
                 ...
                 List<VendorEmployeeRole> VendorEmployeeRoleObj = new List<VendorEmployeeRole>();
                using (StreamReader r = new StreamReader(RootPath+ "Request/VendorEmployeeRole/Request.json"))
                {
                    string json = r.ReadToEnd();
                    VendorEmployeeRoleObj = JsonConvert.DeserializeObject<List<VendorEmployeeRole>>(json);
                }
                /////////////////End Create Object process for insert Testcase/////////////////
                 int ModelCounter = 0;
                foreach (var VendorEmployeeRoleItem in VendorEmployeeRoleObj)
                {
                    ModelCounter++;
                    ResultTest += StrDate + "," + ModelCounter + "," + ModuleName + "," + ListStatus;
                    /////////////////Start Process submit Object for insert Testcase/////////////////
                    var CreateSubmitResult = controller.Submit(VendorEmployeeRoleItem) as ViewResult;
                    Assert.IsTrue(VendorEmployeeRoleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process submit Object for insert Testcase/////////////////


                    /////////////////Start Process for getbyIs Testcase/////////////////
                    var EditResult = controller.Edit(VendorEmployeeRoleItem.Id) as ViewResult;
                    Assert.IsTrue(VendorEmployeeRoleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for getbyIs Testcase/////////////////

                    /////////////////Start Process for Update Testcase/////////////////
                    var UpdateSubmitResult = controller.Submit(VendorEmployeeRoleItem) as ViewResult;
                    Assert.IsTrue(VendorEmployeeRoleItem.Id > 0);
                    ResultTest += ",Passed";
                    ...
                    var DeleteResult = controller.Delete(VendorEmployeeRoleItem.Id) as ViewResult;
                    Assert.IsTrue(VendorEmployeeRoleItem.Id > 0);
                    ResultTest += ",Passed";
                    /////////////////End Process for delete Testcase/////////////////
                     ResultTest += ",Passed";
                    ResultTest += ","+ VendorEmployeeRoleItem.Id+"\n";
                }
